...
This project is a physician assistant to help doctors in the diagnostic phase. Based on the patient information entered by doctors, it analyzes it using Gemini 2.5 based on visual and clinical information about the patient. It lists the preliminary diagnoses that may be related to the patient entered.
